// 原作者：https://github.com/Dragon-chen777/Music-player
...
// 音乐信息
const songs = ["yutaka hirasaka - eau"]
// 默认从第一首开始
let songIndex = 0;
// 将歌曲细节加载到DOM
...
function loadSong(song) {
    ...
    audio.src = `./background/music/${song}.mp3`;      // 路径需要自己设定
    musicCover.src = `./background/cover/${song}.jpg`;
}
